...
import { ScrollView, View, StyleSheet, Switch, Text, TextInput, TouchableOpacity, VirtualizedList, Image } from 'react-native';
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
            ...
            <TextInput
                ...
                onChangeText={text => handleOnChangeOrphanageForm('name', text)}
            />
            ...
            <TextInput
                ...
                onChangeText={text => handleOnChangeOrphanageForm('about', text)}
                multiline
            />
            ...
            <TextInput
                style={styles.input}
                value={orphanageForm.whatsapp}
                onChangeText={text => handleOnChangeOrphanageForm('whatsapp', text)}
            />
            ...
            <TextInput
                ...
                onChangeText={text => handleOnChangeOrphanageForm('instructions', text)}
            />
            ...
            <TextInput
                ...
                onChangeText={text => handleOnChangeOrphanageForm('opening_hours', text)}
            />
